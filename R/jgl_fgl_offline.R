jgl_fgl_offline <-
function(S, lambda1, lambda2, window, rho, obs, max_iter=50, tol=0.001){
  ...
  #     - window is used to determine connectivity graph for fused lasso
  ...
  while(convergence==FALSE & iter < max_iter){
    ...
    Z = minimize_z_fused(A, lambda1, lambda2, rho, connlist=connlist)
